                ...
                <ResultShareBtnWrapper>
                    <CopyToClipboard text={window.location.href}>
                        <ResultShareBtn id={"shareUrl"} onClick={onClickCopyUrl}>
                            <ResultShareBtnImg src={"https://spti.snackpot.kr/images/share/share_url.svg"}/>
                        </ResultShareBtn>
                     </CopyToClipboard>
                    <ResultShareBtn>
                        <ResultShareBtnImg src={"https://spti.snackpot.kr/images/share/share_kakao.svg"}/>
                    </ResultShareBtn>
                    <ResultShareBtn>
                        <ResultShareBtnImg src={"https://spti.snackpot.kr/images/share/share_facebook.svg"}/>
                    </ResultShareBtn>
                </ResultShareBtnWrapper>
